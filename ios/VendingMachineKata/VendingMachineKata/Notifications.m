...
NSString * const kNotificationDisplayUpdated = @"DisplayUpdatedNotification";
NSString * const kNotificationCanMakeChangeForAnything = @"CanMakeChangeForAnythingNotification";
NSString * const kNotificationCannotMakeChangeForAnything = @"CannotMakeChangeForAnythingNotification";
